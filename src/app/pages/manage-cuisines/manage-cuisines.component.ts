...
export class ManageCuisinesComponent implements OnInit {
  ...
  getCuisine() {
    ...
    this.spinner.show();
    this.api.post('restcuisines/getById', param).then((res: any) => {
      this.spinner.hide();
  ...
  create() {
    ...
    this.spinner.show();
    this.api.post('restcuisines/createCuisine', param).then((res: any) => {
      this.spinner.hide();
  ...
  update() {
    ...
    this.api.post('restcuisines/editCuisine', param).then((res: any) => {
      this.spinner.hide();
      if (res && res.data && res.status === 200) {
        this.navCtrl.back();
      } else {
